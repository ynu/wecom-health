 ...
 */
 ...
 const debug = require('debug')('ywecom-health:debug');
 const warn = require('debug')('ywecom-health:warn');
  ...
  */
const report_job_info = async (jobid, date, options = {}) => {
  //规范输入参数
...
const report_answer = async(jobid, options = {}) => {
  ...
  options.secret = options.secret || process.env.HEALTH_SECRET
